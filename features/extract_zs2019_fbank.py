...
def main():
    ...
    if args.subset == "train":
        ...
        feat_dict = features.extract_fbank_dir(path.join(data_dir, "unit"))
        print("Extracting target voice features:")
        feat_dict.update(
            features.extract_fbank_dir(path.join(data_dir, "voice"))
            )
    else:
        print("Extracting test features:")
        feat_dict = features.extract_fbank_dir(data_dir)
